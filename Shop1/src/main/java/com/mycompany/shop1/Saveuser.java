    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
              ...
              stmt.executeUpdate("insert into shop set id=2, first_name='"+f+"', last_name='"+l+"', phone='"+p+"', username='"+u+"', password='"+pass+"'");  
              out.println("Record added successfully, <a href='View'>View</a> what has been added already");
